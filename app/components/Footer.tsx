  ...
  return (
    <footer className="bg-[#1A1A1A] text-gray-200 pt-6 sm:pt-8 md:pt-10 pb-5 sm:pb-6">
      <div className="container mx-auto px-4 sm:px-5 md:px-8">
        {/* Top Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1.1fr_1.3fr_2.5fr] gap-6 sm:gap-8 md:gap-10 items-start">

          {/* About */}
          <div className="flex flex-col h-full">
            {/* Company Heading */}
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold uppercase tracking-wide mb-2 sm:mb-3" style={{ fontFamily: 'var(--font-poppins), Poppins, sans-serif', background: 'linear-gradient(90deg, #FF7A00, #FFC837)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
              GIRIRAJ INDUSTRIES
            </h2>
            <p className="text-sm sm:text-xs md:text-sm lg:text-base leading-relaxed text-gray-300">
          ...
          <div className="flex flex-col h-full space-y-1 sm:space-y-1.5">
            ...
            <div className="space-y-2 sm:space-y-2.5">
              ...
              <div className="flex items-center gap-2">
                <Icon name="map-pin" className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" style={{ color: '#5FAA3F' }} />
                <a 
                  href="https://maps.app.goo.gl/QNnjn1HHTybCD3oi6"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm sm:text-xs md:text-sm text-gray-300 transition-colors duration-200 hover:text-[#5FAA3F]"
                  style={{ fontFamily: 'var(--font-inter), Inter, sans-serif' }}
                >
              ...
              {/* Phone */}
              <div className="flex items-center gap-2">
                <Icon name="phone" className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" style={{ color: '#5FAA3F' }} />
                <a 
              ...
              {/* Email */}
              <div className="flex items-center gap-2">
                <Icon name="mail" className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" style={{ color: '#5FAA3F' }} />
                <a 
              ...
              <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 pt-1">
                {/* WhatsApp */}
                <a 

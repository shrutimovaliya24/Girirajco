...
export default function FloatingContactWidget() {
  ...
  return (
    <div className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-40 group">
      ...
      <div className="absolute bottom-full left-0 mb-2 sm:mb-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-out transform group-hover:translate-y-0 translate-y-2">
